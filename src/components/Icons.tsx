...
export const Icon = {
  ...
  Phone: make(Phone, 'w-3.5 h-3.5'),
  Note: make(StickyNote, 'w-3.5 h-3.5'),
  Cog: make(Settings, 'w-4 h-4'),
  Refresh: make(RefreshCw, 'w-3.5 h-3.5'),
  Scroll: make(ScrollText, 'w-4 h-4'),
  Server: make(HardDrive, 'w-4 h-4'),
  Palette: make(Palette, 'w-4 h-4'),
  SidebarClose: make(PanelLeftClose, 'w-4 h-4'),
  SidebarOpen: make(PanelLeftOpen, 'w-4 h-4'),
  ChevronLeft: make(ChevronLeft, 'w-4 h-4'),
  Gmail: GmailLogo,
};
